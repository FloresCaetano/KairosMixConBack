...
\begin{itemize}
    ...
    \item \textbf{Step Definitions}: Mapeo de escenarios a código Java automatizado para validar las respuestas y el comportamiento de la API.
...
\begin{itemize}
    ...
    \item Pruebas: 49 casos de prueba en \texttt{src/test/java/} y escenarios BDD de Cucumber
